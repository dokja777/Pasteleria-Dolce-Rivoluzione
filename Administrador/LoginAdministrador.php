...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="../css/loginEmpleado.css">
  ...
  <div class="row">
    <div class="col">
      <div class="fondo">
      <div class="imagen">
         <img id="logo" src="../MVC/Public/Assets/img/logo.png"  width="80px" alt="Logo de la pasteleria">
        </div>
       <div class="info">
    ...
    <div class="col">
    <div class="item">
            <form action="funcionalidadLoginAdmin.php" method="POST">
                <h1>INICIA SESIÓN</h1>
                <?php 
                if(isset($_GET['error'])) {
                ?>
            ...
            ?>
                ...
                <input name="Usuario" type="text" placeholder="Ingresar el usuario " >
                <br>
