...
<body>
    ...
    <div class="form-container">
        ...
        <div class="field-container">
            <label for="cardnumber">Número de Tarjeta</label><span id="generatecard">generate random</span>
            <input id="cardnumber" type="text" pattern="[0-9]*" inputmode="numeric">
            <svg id="ccicon" class="ccicon" width="600" height="321" viewBox="0 0  600 600" version="1.1" xmlns="http://www.w3.org/2000/svg"
...
<!-- partial -->
  ...
  <script src="../../../Cliente/vistas/Cliente/MetodosPago/tarjeta.js"></script>
  <link rel="stylesheet" href="../../../Cliente/vistas/Cliente/MetodosPago/tarjetastyle.css" />
