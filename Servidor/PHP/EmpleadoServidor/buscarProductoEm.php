...
<body>
    ...
    <div class="container">
        ...
        <form action="../../../Servidor/PHP/EmpleadoServidor/buscarProductoEm.php" method="post" style="border: 2px solid #783f04; text-align:right; margin-bottom:10px; padding: 10px">
            ...
            WHERE producto.N_PRODUCTO LIKE '%$buscar%'";
                    ...
                    if ($result) {
                        while ($resultado = $result->fetch_assoc()) {
                            ...
                            echo "<td>$stock</td>";
                            echo "<th>
            <a href='../../../Cliente/vistas/Empleado/editarProductoEm.php?id=$idProducto' class=\"btn btn-warning\">Editar</a>
            <br>
            <br>
