...
<html lang="es">
  ...
  <body>
    ...
    <div class="container__masVendidos">
      ...
      $resultado = $conexion->query($query); while ($row =
      $resultado->fetch_assoc()) { ?>
      <div class="card">
        <img
          src="data:image/jpg;base64, <?php echo base64_encode($row['IMG']); ?>"
        />
        <h4>
    ...
    <footer>
      <div class="container__footer">
        ...
        <div class="box__footer">
          ...
          <a href="#"
            ><i class="fa-solid fa-location-dot"></i> Av San Juan N° 1061, SJM
            15801</a
          >
        </div>
